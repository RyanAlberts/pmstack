...
function AgentStatus({ project }) {
  ...
  return html`<section class="assist-agent" aria-label="Claude Code">
    <p><strong>Claude Code can do this for you:</strong> run <code>/pmstack:find-failures</code> (or <code>/pmstack-find-failures</code> if you installed with setup) in this folder. New suggestions appear here automatically.</p>
